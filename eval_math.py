...
def parse_args():
    ...
    parser.add_argument("--data-file", type=str, default='')  # data path
    parser.add_argument("--start", type=int, default=0) #start index
    parser.add_argument("--end", type=int, default=MAX_INT)  # end index
    parser.add_argument("--batch-size", type=int, default=400)  # batch_size
    parser.add_argument("--tensor-parallel-size", type=int, default=2)  # tensor_parallel_size
